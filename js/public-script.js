...
jQuery(document).ready(function($) { 
    ...
    //Custom cursor
    var cursor = jQuery(document).find('.cursor');
    var a = jQuery(document).find('a');

    jQuery(document).on('mousemove','.slider-section', function(e){
      var x = e.clientX;
      var y = e.clientY;
    ...
    jQuery(document).on('mousedown','.slider-section', function(){
      cursor.addClass('click');
    });

    jQuery(document).on('mouseup','.slider-section',function(){
    ...
    jQuery('.team-member').click(function() {
        jQuery(this).next('.team-member-details-wrap').addClass('open');
     });
    jQuery('.team-member-details-wrap').click(function() {
    ...
    jQuery(document).on('mousemove','.team-member-details-wrap', function(e){
      var x = e.clientX;
      var y = e.clientY;
      cursor.css("transform" , `translate3d(calc(${e.clientX}px - 50%), calc(${e.clientY}px - 50%), 0)`);
    });
